...
<body>
    <?php
        ...
        if(isset($_SESSION['customer'])){
            ...
            $phones=$customer['customers_phone'];
        }
        if(isset($_POST['save'])){
            $name=$_POST['name'];
           ...
           if(!empty($_FILES["image"]["name"])){
               ...
               $insert=mysqli_query($conn,"UPDATE `customers` SET `customers_name_details`='$name',`customers_email`='$email',`customers_name_shop`='$nameshop',
               `customers_gender`='$gender',`customers_avatar`='$imagepath' WHERE `customers_phone`=$phones");
           }else{
                $insert=mysqli_query($conn,"UPDATE `customers` SET `customers_name_details`='$name',`customers_email`='$email',`customers_name_shop`='$nameshop',
                `customers_gender`='$gender' WHERE `customers_phone`=$phones");
    ...
    <div class="app-account">
        ...
        <div class="grid-account">
            <div class="app-account-space">
                <div class="grid-column-number-2">
                    <div class="account-navbar">
                        <div class="account-navbar-heading">
                            ...
                            <?php if(!empty($account['customers_avatar'])) { ?>
                                <img src="uploads/<?php echo $account['customers_avatar'] ;?>"
                        ...
                        <div class="account-navbar-container">
                            <div class="account-navbar-container-list">
                                <div class="account-navbar-container-flex">
                                    <div class="account-navbar-container-heading">
                ...
                <div class="grid-column-number-10" id="grid-column-number-10-js">
                                ...
                                <div class="account-profile-container-form">
                                    <div class="account-profile-container-name">
                                        ...
                                        <div class="account-profile-container-padding-x">
                                            <div class="account-profile-container-name-text"><?php echo $account['customers_name']; ?></div>
                                        </div>
                                    </div>
                                    <div class="account-profile-container-name">
                                        <div class="account-profile-container-name-heading">Tên</div>
                                        <div class="account-profile-container-padding">
                                            <input type="text" name="name" value="<?php echo $account['customers_name_details']; ?>" class="account-profile-container-name-inputname">
                                        </div>
                                    </div>
                                    <div class="account-profile-container-name">
                                        <div class="account-profile-container-name-heading">Email</div>
                                        <div class="account-profile-container-padding">
                                            <input type="email" name="email" value="<?php echo $account['customers_email']; ?>" placeholder="abc@email.com" class="account-profile-container-name-inputemail">
                                        </div>
                                    </div>
                                    <div class="account-profile-container-name">
                                        <div class="account-profile-container-name-heading">Số điện thoại</div>
                                        <div class="account-profile-container-padding">
                                            <input type="text" disabled="disabled" value="<?php echo $account['customers_phone']; ?>" class="account-profile-container-name-inputsdt">
                                        </div>
                                    </div>
                                    <div class="account-profile-container-name">
                                        <div class="account-profile-container-name-heading">Tên Shop</div>
                                        <div class="account-profile-container-padding">
                                            <input type="text" name="nameshop"  value="<?php echo $account['customers_name_shop']; ?>" class="account-profile-container-name-inputshop">
                                        </div>
                                    </div>
                                    <div class="account-profile-container-name">
                                        ...
                                        <div class="account-profile-container-name-inputgender">
                                            <div class="account-profile-container-name-inputshop-nam">
                                                <input type="radio" value="NAM" name="gender" checked <?php if(!empty($gender)&& $gender=="NAM") echo "checked='checked'" ;?>
                                            ...
                                            <div class="account-profile-container-name-inputshop-nu">
                                                <input type="radio" value="NU" name="gender" <?php if(!empty($gender)&& $gender=="NU") echo "checked='checked'" ;?>
                                                    class="account-profile-container-name-inputshop-check">
                                            ...
                                            <div class="account-profile-container-name-inputshop-khac">
                                                <input type="radio" value="KHAC" <?php if(!empty($gender)&& $gender=="KHAC") echo "checked='checked'" ;?>
                                                    name="gender"
                                                    class="account-profile-container-name-inputshop-check">
