    ...
    <?php  require_once 'conect.php';
        ...
        if(isset($_POST['login'])){
            ...
            if(mysqli_num_rows($querys)>0){
                $passwordverify=password_verify($password,$account['customers_password']);
                // var_dump($passwordverify);
                if($passwordverify){
                    $_SESSION['customer']=$account;
                    header('Location:index.php');
                }else{ 
                    $error['er']="Số điện thoại hoặc mật khẩu không đúng.";
    ...
    <div class="header-register">
        <div class="grid-register">
                <div class="header-register-header">
                    ...
                    <div class="header-register-text">Đăng Nhập</div>
                </div>
                    ...
                    <div class="container-form">
                        <div class="form-register">
                            ...
                            <div class="form-register-form-input">
                                <input type="text" name="phone" class="form-register-input" placeholder="Số điện thoại">
                            </div>
                            

                            <div class="notidicatio-error"><?php echo isset($error['er'])?$error['er']:"" ;?></div>

                          
                            <div class="form-register-form-input">
                                <input type="text" name="password" class="form-register-input" placeholder="Nhập mật khẩu">
                            </div>
                        ...
                        <div class="form-register-container-button">
                            <button name="login" class="form-register-button-submit">Đăng Nhập</button>
                        ...
                        <div class="form-register-login-login">
                            <div class="form-register-submit-text-item-text">Bạn mới biết đến Shopping? </div>
                            <a href="register.php" class="form-register-login-link">Đăng Ký</a>
                        </div>    
