...
<body>
 <?php require_once 'conect.php';
    if(isset($_POST['delete'])){
        $iddelete=$_POST['proid'];
        // var_dump($iddelete);exit;
        $sqldelete=mysqli_query($conn,"DELETE FROM `products_details` WHERE `products_id`=$iddelete");
        
        if($sqldelete){
            $sqldeleteimage=mysqli_query($conn,"DELETE FROM `image` WHERE `products_id`=$iddelete");
            $sqldeletepro=mysqli_query($conn,"DELETE FROM `products` WHERE `products_id`=$iddelete");
            if($sqldeletepro){
                    ...
                    <div class="container-conatiner">
                        <div class="container-see">
                            <div class="container-see-big">
                                ...
                                <div class="container-see-heading-price-last">giá </div>
                                <div class="container-see-heading-quantity">số lượng </div>
                                <div class="container-see-heading-price">Thao tác </div>
                                <div class="container-see-heading-details">Thao tác</div>
                            </div>
                            <div class="container-see-products">
                                ...
                                <div class="container-see-data">
                                    ...
                                    <a  href="fix.php?id=<?=$showproduct['products_id']?>" class="container-see-data-details"><i class="fal fa-wrench"></i></a>
                                    <form method="POST" class="form-center" action="" >
                                    <button name="delete" class="container-see-data-details"><i class="fal fa-trash-alt"></i></button>
                                    
                                </div>
                                        <input type="hidden" name="proid" value="<?=$showproduct['products_id']?>">
                                    </form>
                                <?php } ?>
